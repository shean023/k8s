...
替换后的 kube-proxy.config.yaml 文件：[kube-proxy.config.yaml](https://github.com/shean023/k8s/blob/master/systemd/kube-proxy.config.yaml)
...
替换后的 unit 文件：[kube-proxy.service](https://github.com/shean023/k8s/tree/master/systemd/kube-proxy.service)
