...
stream {
    upstream backend {
        ...
        server 192.168.52.130:6443        max_fails=3 fail_timeout=30s;
        server 192.168.52.131:6443        max_fails=3 fail_timeout=30s;
        server 192.168.52.132:6443        max_fails=3 fail_timeout=30s;
    }
