...
完整 unit 见 [docker.service](https://github.com/shean023/k8s/blob/master/systemd/docker.service)
...
for node_ip in ${WORKER_NODE_IPS[@]}
  do
    ...
    scp /etc/sysctl.d/kubernetes.conf root@${node_ip}:/etc/sysctl.d/kubernetes.conf
