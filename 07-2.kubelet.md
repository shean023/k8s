...
参考 [06-0.部署master节点.md](06-1.部署master节点.md)
...
替换后的 kubelet-config.yaml 文件： [kubelet-config.yaml](https://github.com/shean023/k8s/blob/master/systemd/kubelet.kubeconfig)
...
替换后的 unit 文件：[kubelet.service](https://github.com/shean023/k8s/blob/master/systemd/kubelet.service)
...
kube-master   Ready    <none>   4m12s   v1.12.3
kube-node1   Ready    <none>   4m13s   v1.12.3
kube-node2   Ready    <none>   12s     v1.12.3
```
